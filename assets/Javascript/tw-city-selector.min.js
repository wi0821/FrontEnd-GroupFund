        ...
        function (i, t, n) {
                ...
                return (
                    ...
                    this.options.bootstrapStyle &&
                        function () {
                            ...
                            this.elCounty.setAttribute("id", "registerCounty"), this.elDistrict.setAttribute("id", "registerDistrict"), this.options.hasZipcode && this.elZipcode.setAttribute("id", "registerZipcode");
                    ...
                    function () {
                        var i = function () {
                            var i = this.elCounty.querySelector("option:checked").getAttribute("data-index");
                            c.call(this, i), this.options.hasZipcode && (this.elZipcode.value = "");
                        }.bind(this);
                        this.elCounty.onchange = i;
                    }.call(this),
                    function () {
                        var i = function () {
                            var i = this.elDistrict.querySelector("option:checked").dataset.zipcode || "";
                            (this.options.hasZipcode || this.elZipcode) && (this.elZipcode.value = i);
                        }.bind(this);
            ...
            (t.default = h),
                ...
                (h.prototype.reset = function () {
                    return (
                        function () {
                            return (this.elCounty.selectedIndex = 0), c.call(this), this.options.hasZipcode && (this.elZipcode.value = ""), this;
                        }.call(this),
                        this
                    );
                }),
